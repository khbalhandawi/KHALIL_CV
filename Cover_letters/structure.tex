...
\newcommand{\workposition}[7]{
	...
	\expandafter\ifstrequal\expandafter{#4}{}{}{& {\raggedright\textsc{#4}}\\} % Location
	\expandafter\ifstrequal\expandafter{#5}{}{}{& {\raggedright\large\textit{\textbf{#5}}}\\[4pt]} % Job title
...
\newcommand{\educationentry}[5]{
	...
	\expandafter\ifstrequal\expandafter{#3}{}{}{, {\small\textsc{#3}}\\[6pt]} % Honours, achievements or distinctions (e.g. first class honours)
}
