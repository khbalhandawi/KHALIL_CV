...
\newcommand{\profilesection}[1]{%
	...
	{\color{headings} \scshape\LARGE #1 \\\rule[0.3\baselineskip]{\TotalSectionLength}{0.5pt}}% Print the title and auto-width rule
}
	...
	\renewcommand{\skills}{
		\begin{tikzpicture}
			\foreach [count=\i] \x/\y in {#1}{
				...
				\draw[fill=white,headings](0,\i) rectangle (\y,\i+0.4);
