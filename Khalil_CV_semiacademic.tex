...
\begin{supertabular}{>{\raggedright\arraybackslash}p{0.17\linewidth}>{\raggedright\arraybackslash}p{0.77\linewidth}} % Start a table with three columns, the table will ensure everything is aligned
	...
	\tableentrytwo{}{-~~System dyanmics models}{spaceafter}
...
\begin{supertabular}{>{\raggedleft\arraybackslash}p{0.17\linewidth}p{0.77\linewidth}} % Start a table with three columns, the table will ensure everything is aligned
	...
	\tableentry{$\bullet$}{Co-developed a novel lifecycle cost model based on system dynamics models.}{}
	...
	{}{}  % Description
	\tableentry{$\bullet$}{Participated in a technology transfer to translate my research into industrial practice.}{}
	\tableentry{$\bullet$}{Provided training modules and workshops to GKN engineers on set-based design and optimization (MATLAB and Python).}{}
	\tableentry{$\bullet$}{Collected information about industrial workflows to guide academic research.}{spaceafter}
	...
	\tableentry{$\bullet$}{Simulated photonic corrosion sensors in MATLAB and Abaqus to aid in sensor design and calibration.}{}
	...
	\tableentry{$\bullet$}{Lead the 1st national team of the United Arab Emirates to ever compete in the international Baja SAE competition (Maryland, 2015).}{}
