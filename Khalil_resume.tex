...
\references{
	\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
		...
		\tableentry{}{\textbf{Dr. Ahmed Bayoumy}}{spaceafter}
		\tableentry{Position}{Advanced Development Engineer}{}
		\tableentry{Employer}{\href{https://www.sw.siemens.com/en-US/}{Siemens Digital Industries}}{}
		\tableentry{Email}{\href{mailto:ahmed.bayoumy@siemens.com}{ahmed.bayoumy@siemens.com}}{}
...
\begin{supertabular}{>{\raggedleft\arraybackslash}p{0.3\columnwidth}@{\hspace{0.5\tabcolsep}}c>{\raggedright\arraybackslash}p{0.6\columnwidth}} % Start a table with three columns, the table will ensure everything is aligned
	...
	\tableentrythree{Scientific libraries}{\faCogs}{Qt, PyTorch, CUDA, Eigen, dlib}{spaceafter}
	\tableentrythree{Source control}{\faCodeFork}{Git, Perforce}{spaceafter}
	\tableentrythree{Interactive development environments}{\faListAlt}{VSCode, Xcode, Visual Studio}{spaceafter}
\end{supertabular}
...
\begin{paracol}{2} % Begin the multi-column environment
	...
	\begin{supertabular}{>{\raggedleft\arraybackslash}p{0.14\columnwidth}l} % Start a table with three columns, the table will ensure everything is aligned
		...
		\tableentry{}{\skilllevel{Machine learning}{4}}{}
		\tableentry{Matlab}{\skilllevel{Transfer learning}{2}}{}
...
\begin{supertabular}{>{\raggedleft\arraybackslash}p{0.3\columnwidth}@{\hspace{0.5\tabcolsep}}c>{\raggedright\arraybackslash}p{0.6\columnwidth}} % Start a table with three columns, the table will ensure everything is aligned
	\tableentrythree{Spoken Languages}{\faCommentO}{English (Fluent), Arabic (Fluent), French (Basic)}{spaceafter}
	...
	\tableentrythree{Interpersonal skills}{\faCommentsO}{Love working with others as a team, learning from them, and teaching others.}{}
\end{supertabular}
