...
\begin{supertabular}{>{\raggedleft\arraybackslash}p{0.17\linewidth}p{0.79\linewidth}} % Start a table with three columns, the table will ensure everything is aligned
	...
	{}{}  % Description
	\tableentry{$\bullet$}{Worked in a \textbf{Canadian/European industrial project} for additive repair technologies in aerospace parts. I focused on process optimization and remanufacturing options.}{}
