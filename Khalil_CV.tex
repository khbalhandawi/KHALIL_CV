...
\cvaddress{500 Avenue Des Pins Ouest, Apt 706\\ & H2W 1S7, Montr\'{e}al, Qu\'{e}bec, Canada} % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{(514) 572-7367} % Phone number
\cvsite{khbalhandawi.github.io} % Personal website
\cvmail{khalilbassaam@hotmail.com} % Email address
...
% optional sections
% show descriptions of below sections, to hide simply leave blank e.g., \cvdescribe{}
\cvdescribe{}
\cvskills{}
\cvhobbies{}
\cvreferences{}
...
\parbox[top][0.1\textheight][c]{\linewidth}{ % Parbox to hold the colour box; fixed height to match the name/CV text to the left, centred vertically and full line width
	...
	\colorbox{shade}{ % Create the coloured box
		\begin{supertabular}{p{0.05\linewidth}|p{0.775\linewidth}} % Start a table with two columns, the table will ensure everything is aligned
			...
			\raisebox{-1pt}{\faHome} & \cvaddress \\ % Address
...
\begin{supertabular}{>{\raggedleft\arraybackslash}p{0.19\linewidth}p{0.58\linewidth}>{\raggedleft\arraybackslash}p{0.17\linewidth}} % Start a table with three columns, the table will ensure everything is aligned
...
\begin{supertabular}{>{\raggedleft\arraybackslash}p{0.19\linewidth}p{0.77\linewidth}} % Start a table with three columns, the table will ensure everything is aligned

	%------------------------------------------------

	\workposition{Aug 2023 -- present} % Duration
	{} % FT/PT (full time or part time)
	{Transformation of Industry, Siemens Energy Canada} % Employer
	{Montr\'{e}al, Canada} % Location
	{R\&D project manager / Optimization Specialist} % Job title
	{}{} % Description
	% \tableentry{$\bullet$}{Develop statistical learning tools to accelerate simulation workflows of Turbomachinery.}{}
	% \tableentry{$\bullet$}{Develop optimization algorithms for solving engineering design problems.}{}
	\tableentry{$\bullet$}{Design and propose future research projects pertinent to the energy industry.}{}
	\tableentry{$\bullet$}{Manage and train university students working on various R\&D projects.}{}
	\tableentry{$\bullet$}{Disseminate research results at prominent turbomachinery and automation conferences.}{}
	\tableentry{$\bullet$}{Ensure a smooth and continuous industrial technology transfer for various R\&D projects.}{spaceafter}

	%------------------------------------------------

	\workposition{May 2022 -- Jul 2023} % Duration
	{} % FT/PT (full time or part time)
	...
	{Postdoctoral Researcher} % Job title
	{}{} % Description
	\tableentry{$\bullet$}{Research simulation-based decision-making for public health policies during epidemics.}{}
	\tableentry{$\bullet$}{Developed several \href{https://covid-forecaster-lebanon.herokuapp.com/}{machine learning COVID-19 forecasting models} for inferring weekly pandemic trajectories.}{}
	...
	\tableentry{$\bullet$}{Invited to speak at the \href{https://meetings.informs.org/wordpress/healthcare2023/}{INFORMS Healthcare conference 2023} in Toronto.}{spaceafter}
	...
	{}{}  % Description
	\tableentry{$\bullet$}{Was part of a \textbf{Canadian/European industrial project} investigating additive repair technology for aeroengines. I focused on optimization of design for AM remanufacturing.}{}
	\tableentry{$\bullet$}{Developed mathematical tools and \href{https://github.com/khbalhandawi/scale_AM_webapp}{software} for design space exploration and optimization achieving a \textbf{90\% reduction} in effort to explore a 4-dimensional design space relative to full factorial design.}{}
	\tableentry{$\bullet$}{Developed a thermomechanical simulation model for modeling additive manufacturing repair and life extension processes using coupled thermal/mechanical FEA simulations.}{}
	...
	\tableentry{$\bullet$}{Research change propagation and absorption in design (applied to aeroengine systems).}{}
	\tableentry{$\bullet$}{Authored a \href{https://sed-group.github.io/mvmlib/index.html}{Python library} for margin analysis in engineering systems.}{}
	\tableentry{$\bullet$}{Used said library in design space exploration to concurrently develop and analyze \textbf{6,552 conceptual designs} of an aeroengine component and \href{https://khbalhandawi.github.io/projects/1_project/}{visualize the results} interactively.}{spaceafter}
	...
	{Research Assistant} % Job title
	{}{} % Description
	\tableentry{$\bullet$}{Developed fiber optic structural monitoring sensors to mitigate \textbf{\$1M of corrosion costs}.}{}
	\tableentry{$\bullet$}{Developed a \href{https://khbalhandawi.github.io/projects/6_project/}{fiber optic-based corrosion sensor} with an accuracy of \textbf{$\pm$2mm/s}.}{}
	\tableentry{$\bullet$}{Developed an accelerated corrosion test setup to simulate \textbf{2 years of corrosion in 2 hours}.}{spaceafter}
...
\hrule \medskip \textbf{\large Industry}
...
\begin{supertabular}{>{\raggedleft\arraybackslash}p{0.19\linewidth}p{0.77\linewidth}} % Start a table with three columns, the table will ensure everything is aligned
	...
	% {Transformation of Industry, Siemens Energy Canada} % Employer
	% {Montr\'{e}al, Canada} % Location
	% {R\&D project manager} % Job title
	% {}{} % Description
	% \tableentry{$\bullet$}{Ensure a smooth and continuous technology transfer for various R\&D projects.}{spaceafter}
	...
	\tableentry{$\bullet$}{Develop community detection algorithms for heterogeneous graphs.}{}
	...
	\workposition{Jun 2017 -- Jan 2020} % Duration
	{} % FT/PT (full time or part time)
	...
	\tableentry{$\bullet$}{Surveyed GKN engineers about their design experience with areoengine components to understand the timeline for expected design updates and changes. This data formed the basis of a case study for my research on design for flexibility and robustness.}{}
	...
	{}{} % Description
	\tableentry{$\bullet$}{Write programs for industrial plant operation and control on Distributed Control Systems.}{}
...
\begin{supertabular}{>{\raggedleft\arraybackslash}p{0.19\linewidth}p{0.77\linewidth}} % Start a table with three columns, the table will ensure everything is aligned
	...
	{}{} % Description
	\tableentry{$\bullet$}{Developed \href{https://github.com/khbalhandawi/MECH559_notebooks/tree/master}{Python notebooks} as teaching aids to explain the implementation of common optimization algorithms and their application to engineering systems.}{}
	\tableentry{$\bullet$}{Received participation rate of \textbf{69\%} in course evaluations with an average score of \textbf{4.2/5.0}.}{}
	\tableentry{$\bullet$}{Hosted \textbf{guest} lectures with industry professionals to demo optimization applications.}{spaceafter}
	...
	\tableentry{$\bullet$}{Report areas of the curriculum that students struggle with to the department.}{spaceafter}
	...
	\tableentry{$\bullet$}{Conducted town halls on relevant sociapolitical topics facing modern day engineers.}{}
	...
	{}{} % Description
	\tableentry{$\bullet$}{Conduct computer lab sessions on modern CAD software (SolidWorks).}{}
	...
	{}{} % Description
	\tableentry{$\bullet$}{Graded homework and exams for the undergraduate physics course.}{spaceafter}
...
\begin{supertabular}{>{\raggedleft\arraybackslash}p{0.19\linewidth}p{0.58\linewidth}>{\raggedleft\arraybackslash}p{0.17\linewidth}} % Start a table with three columns, the table will ensure everything is aligned
	...
	\tableentrythree{Aug 2023 -- present}{{\textbf{Digital multidisciplinary analysis and design optimization, Siemens Energy}}}{Montr\'{e}al, Canada}{spaceafter}
	\tableentry{$\bullet$}{Student name: Abdessamad Idoumghar (Masters student)}{} % Description
	\tableentry{}{Affiliation: \'{E}cole de technologie sup\'{e}rieure}{}
	\tableentry{}{Domain: Nonlinear programming, least squares}{spaceafter}
	\tableentry{$\bullet$}{Student name: Aravind Kumar Parthasarathy (Masters student)}{} % Description
	\tableentry{}{Affiliation: McGill University}{}
	\tableentry{}{Domain: Solid mechanics, topology optimization}{spaceafter}
	\tableentry{$\bullet$}{Student name: Vraj Patel (Masters student)}{} % Description
	\tableentry{}{Affiliation: McGill University}{}
	\tableentry{}{Domain: Combinotorial optimization, process engineering}{spaceafter}
	\tableentry{$\bullet$}{Student name: Anas Haitof (Masters student)}{} % Description
	\tableentry{}{Affiliation: \'{E}cole de technologie sup\'{e}rieure}{}
	\tableentry{}{Domain: CFD, surge identification, and algorithm design}{spaceafter}
	\tableentry{$\bullet$}{Student name: Axel Koubemba (Masters student)}{} % Description
	\tableentry{}{Affiliation: \'{E}cole de technologie sup\'{e}rieure}{}
	\tableentry{}{Domain: Multidisciplinary and Derivative-free optimization}{spaceafter}
	\tableentry{$\bullet$}{Student name: Mathieu Salz (Bachelors student)}{} % Description
	\tableentry{}{Affiliation: McGill University}{}
	\tableentry{}{Domain: Physics informed neural networks, Aerodynamics}{spaceafter}
	\tableentry{$\bullet$}{Student name: Dan Mihail Bala (Bachelors student)}{} % Description
	\tableentry{}{Affiliation: \'{E}cole de technologie sup\'{e}rieure}{}
	\tableentry{}{Domain: Derivative-free optimization}{spaceafter}
	\tableentry{$\bullet$}{Student name: Fozail Ahmad (PhD student)}{} % Description
	\tableentry{}{Affiliation: McGill University}{}
	\tableentry{}{Domain: Cloud computing and software design}{spaceafter}
...
\longformpublication{\textbf{K. Al Handawi}, A. Brahma, D. Wynn, M. Kokkolaras and O. Isaksson (2023). Design space exploration and evaluation using margin-based trade-offs. \textit{Journal of Mechanical Design}, \textit{in press}, \href{https://doi.org/10.1115/1.4051607}{doi: 10.1115/1.4051607}\\
\textit{funded partially by NSERC and Area of Advance of Chalmers University}}

\longformpublication{\textbf{K. Al Handawi}, A. Brahma, D. Wynn, M. Kokkolaras and O. Isaksson (2023). Design space exploration and evaluation using margin-based trade-offs. \textit{Journal of Mechanical Design}, \textit{144}(1): pp 012001. \href{https://doi.org/10.1115/1.4051607}{doi: 10.1115/1.4051607}\\
...
%------------------------------------------------
\textbf{\large Submitted conference papers}\medskip \hrule \medskip

\longformpublication{M. Sage, \textbf{K. Al Handawi}, Y. F. Zhao (2024). Economic Dispatch of Hybrid Renewable Energy Systems with Battery Energy Storage and Gas Turbines using Deep Reinforcement Learning \textit{IISE Annual Conference and Expo}}

\longformpublication{Can Unlusoy, M. Salz, B. Maier, \textbf{K. Al Handawi}, M. V. Tittu, R. Srinivasan, M. Kokkolaras (2024). Advancing Airfoil Design: A Generative AI and PINNs Approach \textit{ASME 2024 Turbomachinery Technical Conference \& Exposition}}
...
\begin{supertabular}{>{\raggedright\arraybackslash}p{0.77\linewidth}>{\raggedleft\arraybackslash}p{0.2\linewidth}} % Start a table with three columns, the table will ensure everything is aligned
	...
	\tableentryraw{Awarded \textbf{2nd place} for final problem presentation and winner of best data visualization in the 11th Montreal Industreal Problem Solving Workshop}{\textsc{IVADO, Universit\'{e} de Montr\'{e}al, Canada}}{spaceafter}
	...
	\tableentryraw{Awarded \textbf{2nd place} in the Abu Dhabi Solar Challenge (10,000 AED)}{\textsc{Khalifa University, Abu Dhabi, UAE}}{}
...
\begin{supertabular}{>{\raggedright\arraybackslash}p{0.65\linewidth}>{\centering\arraybackslash}p{0.3\linewidth}} % Start a table with three columns, the table will ensure everything is aligned
