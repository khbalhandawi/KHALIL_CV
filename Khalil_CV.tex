...
\begin{supertabular}{>{\raggedleft\arraybackslash}p{0.17\linewidth}p{0.79\linewidth}} % Start a table with three columns, the table will ensure everything is aligned
	...
	{} % FT/PT (full time or part time)
	{Transformation of Industry, Siemens Energy Canada Limited} % Employer
	{Montr\'{e}al, Canada} % Location
	{DMADO Program Manager} % Job title
	{}{} % Description
	\tableentry{$\bullet$}{Manage the R\&D project: Digital Multidisciplinary Analysis and Design Optimization (DMADO).}{}
	\tableentry{$\bullet$}{Supervise and provide technical support to DMADO interns on various research topics related to optimization, simulation, and machine learning.}{}
	\tableentry{$\bullet$}{Consult for various teams within the company to support their digitalization efforts.}{}
	\tableentry{$\bullet$}{Manage budget, expenses, and other administrative related aspects of the project.}{spaceafter}
	...
	\tableentry{$\bullet$}{Perform GPU accelerated Monte Carlo simulation to extract statistics of aviation networks.}{}
	...
	{}{}  % Description
	\tableentry{$\bullet$}{Developed fiber optic structural monitoring sensors to mitigate corrosion cost in O\&G structures.}{}
