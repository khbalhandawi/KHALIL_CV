...
\begin{supertabular}{>{\raggedleft\arraybackslash}p{0.19\linewidth}p{0.77\linewidth}} % Start a table with three columns, the table will ensure everything is aligned
	...
	\tableentry{$\bullet$}{Design and propose future research projects with an impact on the energy industry.}{}
	...
	\workposition{May 2022 -- July 2023} % Duration
	{} % FT/PT (full time or part time)
